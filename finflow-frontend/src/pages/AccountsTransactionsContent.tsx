        ...
        <div className="flex flex-row flex-wrap items-stretch gap-6 rounded-xl bg-white p-6 shadow-sm">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-5">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-base font-semibold text-gray-900">{card.accountDisplayName}</p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="text-sm font-medium text-gray-500">Provider</p>
              <p className="text-base font-semibold text-gray-900">{card.providerAccountName}</p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="text-sm font-medium text-gray-500">Balance</p>
              <p className="text-base font-semibold text-gray-900">{formatMoney(card.money)}</p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="text-sm font-medium text-gray-500">Type</p>
              <p className="text-base font-semibold text-gray-900">{card.accountType}</p>
            </div>
